const Header = () => {
  return (
    <header className="relative py-5 flex justify-center">
      <div className="fixed top-5 left-1/2 transform -translate-x-1/2 w-4/5 max-w-4xl h-14 rounded-3x flex items-center justify-between px-8 text-white shadow-lg">
