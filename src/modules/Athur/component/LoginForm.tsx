...
export default function Login() {
  // ✅ Use correct state variables
  const [username, setUsername] = useState<string>(''); // or use 'email' if backend supports it
  ...
  return (
    <div className="relative w-full flex items-center justify-center min-h-screen font-sans bg-zinc-50 dark:bg-zinc-950">
        ...
        <form className="space-y-4" onSubmit={handleSubmit}>
          <div className="space-y-2">
            ...
            <input
              ...
              className="flex h-9 w-full rounded-md border border-zinc-200 dark:border-zinc-800 bg-white dark:bg-zinc-950 px-3 py-2 text-sm shadow-sm placeholder:text-zinc-500 dark:placeholder:text-zinc-400 focus-visible:outline-none focus-visible:ring-1 focus-visible:ring-zinc-950 dark:focus-visible:ring-zinc-300 disabled:cursor-not-allowed disabled:opacity-50"
            />
          </div>
          ...
          <div className="space-y-2">
            ...
            <div className="relative">
              <input
                ...
                className="flex h-9 w-full rounded-md border border-zinc-200 dark:border-zinc-800 bg-white dark:bg-zinc-950 px-3 py-2 pr-10 text-sm shadow-sm placeholder:text-zinc-500 dark:placeholder:text-zinc-400 focus-visible:outline-none focus-visible:ring-1 focus-visible:ring-zinc-950 dark:focus-visible:ring-zinc-300"
              />
              <button
                type="button"
