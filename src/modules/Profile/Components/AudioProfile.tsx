            ...
            <div className="space-y-4">
              <div className="relative">
                <input
                  ...
                  className="w-full px-4 py-3 border-2 border-gray-200 dark:border-gray-700 rounded-2xl file:mr-4 file:py-2 file:px-4 file:rounded-xl file:border-none file:bg-blue-800 file:text-blue-300 file:font-medium hover:file:bg-blue-700 focus:border-blue-500 focus:ring-4 focus:ring-blue-200 dark:focus:ring-blue-300/50 outline-none transition-all duration-200 bg-white dark:bg-gray-800 text-gray-700 dark:text-gray-300 cursor-pointer"
